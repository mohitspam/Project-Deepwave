...
const EarthSphere = ({ onCoordinateClick }: GlobeProps) => {
  ...
  const handleClick = useCallback((event: ThreeEvent<MouseEvent>) => {
    ...
    // Convert 3D coordinates to lat/lng using proper spherical coordinate conversion
    // Latitude: angle from equator (y component)
    const lat = Math.asin(y / radius) * (180 / Math.PI);
    
    // Longitude: angle around the y-axis (corrected for Three.js coordinate system)
    // Three.js uses Z-forward, X-right coordinate system
    // We need to adjust for the texture mapping orientation
              ...
              <div className="space-y-3">
                ...
                <div className="pt-2 border-t border-gray-600">
                  ...
                  <div className="text-xs text-green-300">
                    {/* Location hints */}
                    {selectedCoords.lat > 50 && selectedCoords.lng > 100 ? "🇷🇺 Russia Region" :
